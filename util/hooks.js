const { NEXT_PUBLIC_BACK_DAYS } = process.env
...
export const Day1 = new Date(Date.now() - ((NEXT_PUBLIC_BACK_DAYS * 86400000) + 28800000)).toLocaleDateString("en-US", { timeZone: "America/Chicago" })
export const Day2 = new Date(Date.now() + (57600000 - (NEXT_PUBLIC_BACK_DAYS * 86400000))).toLocaleDateString("en-US", { timeZone: "America/Chicago" })

export const NewGTE = () => {
  let Day1 = new Date(Date.now() - ((NEXT_PUBLIC_BACK_DAYS * 86400000) + 28800000)).toLocaleDateString("en-US", { timeZone: "America/Chicago" })
  return new Date(Day1 + " 08:00:00 AM UTC")
}

export const NewLT = () => {
  let Day2 = new Date(Date.now() + (57600000 - (NEXT_PUBLIC_BACK_DAYS * 86400000))).toLocaleDateString("en-US", { timeZone: "America/Chicago" })
  return new Date(Day2 + " 08:00:00 AM UTC")
}


export const NewOEE = () => {
  let Day3 = new Date(Date.now() - ((NEXT_PUBLIC_BACK_DAYS * 86400000) + 28800000)).toLocaleDateString("en-US", { timeZone: "America/Chicago" })
...
export const Calculate = {
  TEEP: (Model) => PercentStyleForOEE(((parseFloat(Model.Q) * parseFloat(Model.A) * parseFloat(Model.P) * parseFloat(Model.U)) / 100000000) || 0),
  ...
  U: (Model) => PercentStyleForOEE((Number(Model.REAL_AVAILABLE_TIME) / Number(Model.AVAILABLE_TIME)) || 0),
