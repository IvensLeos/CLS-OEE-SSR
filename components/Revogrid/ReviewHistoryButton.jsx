...
const ReviewHistoryButton = ({ Machine }) => {
  let Router = useRouter()

  return (
    <>
      <button type="button" className="btn btn-sm btn-primary ReviewHistoryButton" onClick={() => Router.push("/history/data/machine/" + Machine)}>
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" className="bi bi-list-columns-reverse" viewBox="0 0 16 16">
        ...
        <span> REVIEW MACHINE HISTORY</span>
      </button>
      <style jsx>{`
        :global(.ReviewHistoryButton) {
